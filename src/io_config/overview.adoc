...
url: doc/io_config/overview.html
...
== [[ParameterBased]]Parameter Based I/Os
...
. xref:./sysfs.adoc[SysFs (Raspberry Pi, Beagle Bone Black and Similar Boards)] (older way to access GPIO pins)


== [[IO_CONFIGBased]]IO_CONFIG Based I/Os
...
. xref:./gpiochip.adoc[GPIOChip (Raspberry Pi, Beagle Bone Black and Similar Boards)] (newer way to access GPIO pins)
. xref:./plc01a1.adoc[PLC01A1]
. xref:./revolutionpi.adoc[Revolution Pi]
. xref:./wago_pfc200.adoc[Wago PFC200]
