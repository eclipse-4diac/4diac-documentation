...
image:./img/bbbTrafficController/Putty_interface.png[Putty Interface]

The username `root` without password should work on a BBB that has not been accessed before.

image:./img/bbbTrafficController/BBB-ssh.png[Login into the BBB through SSH]
...
image:./img/bbbTrafficController/defaultVia.png[Default route via Ethernet]
...
image:./img/bbbTrafficController/multicast.png[Multicast allowed in both ethernet and usb interfafces]
...
image:./img/bbbTrafficController/Traffic-light-system.jpg[Traffic light system]
...
image:./img/bbbTrafficController/Traffic-light-download.jpg[Traffic light download]
...
image:./img/bbbTrafficController/Traffic-light-running.jpg[Traffic light running]
...
image:./img/bbbTrafficController/routeMissing.png[Route Missing]
...
image:./img/bbbTrafficController/routeAdded.png[Route Added]
