...
If you do not know how to build the 4diac FORTE read the xref:../installation/overview.adoc#ownFORTE[build instructions first]. 
...
Please have a look at the xref:../installation/overview.adoc#ownFORTE[build instructions] if you do not know how to build your own function block, or use the 4diac FBE.
