...
4diac FORTE uses the https://open62541.org/[open62541] OPC UA stack which is open source and can also be used in commercial projects free of charge.
...
The following steps show the commands for https://gitforwindows.org/[Git Bash].
+
----
...
. Optionally you can now monitor the Application in 4diac FORTE, e.g., watch the values of SUBSCRIBE and PUBLISH FB. 
  See xref:../tutorials/use4diaclocally.adoc#monitoringApplication[Use Eclipse 4diac locally Tutorial - Monitor] on how to do that.
