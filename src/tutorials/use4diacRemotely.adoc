...
image:./img/Step3/remoteArchitecture.png[architecture for the current step]
...
. Go to the System Configuration of the _BlinkTest_ and change the address from localhost to the IP address of your device. 
  ...
  image:./img/Step3/deviceAddress.png[changing the device address]
...
* 4diac FORTE does not run on the external device +
  ...
  image:./img/Step3/downloadError.png[Major Download Error pop-up]
