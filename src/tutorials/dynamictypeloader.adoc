...
Otherwise, follow the steps xref:../installation/overview.adoc[here].
...
Before configuring the Lua options, please enable all options, shown in this xref:../installation/overview.adoc#generateFilesForCompiling[tutorial].
