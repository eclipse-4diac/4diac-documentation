...
image:Step2/insert_new_fbs.png[architecture for the current step]
...
image:Step2/add_new_device.png[Add another device to the system]
...
image:Step2/map_new_fbs.png[Mapping of Function Block Instances within the Application Editor]
...
image:Step2/blinky_res_editor.png[incomplete FBs show die broken connection between two devices]
image:Step2/counter_res_editor.png[incomplete FBs show die broken connection between two devices]
...
image:Step2/insert_publish_fb.png[Blinky_RES completely connected]
...
image:Step2/insert_subscribe_fb.png[Counter_RES completely connected]
