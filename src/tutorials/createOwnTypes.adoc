...
image:./img/Step4/newTypeWizardBasic.png[New Type Wizard - Create a Basic Function Block]
...
image:./img/Step4/typeBasicGeneral.png[General View after Creating a Basic Function Block]
...
image:./img/Step4/createBasicInterface.png[Create Basic Type - Interface]
...
----
+
image:./img/Step4/addAlgorithm.png[Add an Algorithm to the Action]
...
+
image:./img/Step4/stateAndActions.png[Current score of the States And Actions]
...
image:./img/Step4/createBasicECC.png[Basic ECC example]
...
image:./img/Step4/newTypeWizardSimple.png[New Type Wizard - Create a Simple Function Block]

. Change the interface as link:#changeInterface[before]. 
+ 
image:./img/Step4/createSimpleInterface.png[Create Simple Type - Interface]
...
+
image:./img/Step4/createSimpleFBAlgorithm.png[Simple FB Algorithm example]
...
image:./img/Step4/newTypeWizardComposite.png[New Type Wizard - Create a Composite Function Block]

. Change the interface as link:#changeInterface[before]. 
+ 
image:./img/Step4/createCompositeInterface.png[Create Composite Type - Interface]
...
+
image:./img/Step4/createCompositeNetwork.png[Composite Network example]

That's all you need to do for the Composite Function Block.

== [[createService]]Create a Service Function Block
...
image:./img/Step4/newTypeWizardServiceInterface.png[New Type Wizard - Create a Service Interface Function Block]

Change the interface as link:#changeInterface[before].

image:./img/Step4/createServiceInterfaceInterface.png[Create Service Interface Type - Interface]

That's it. 
The behavior of the Service Function Block must be implemented directly in the code that's generated from it. 
...
image:./img/Step4/selectExportType.png[Select Export Type]
...
image:./img/Step4/export4DIACTypeWizard.png[Export Type Wizard]
...
image:./img/Step4/exportMergeWindow.png[Export Merge Window,width=1024]
