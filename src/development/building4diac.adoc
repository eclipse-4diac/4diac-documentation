...
. Navigate to your cloned 4diac IDE repository folder and open:`org.eclipse.fordiac.ide/data/`
...
. The `.metadata` folder inside the workspace is hidden by default.
  ...
  On Windows: Enable Hidden Items from the View menu in File Explorer.

  On macOS: Press ⁠ Command + Shift + . ⁠ to show hidden files.

. Open the ⁠ .metadata ⁠ folder.

. Inside the workspace open the following path:⁠ .metadata/.plugins/org.eclipse.pde.core/.bundle_pool ⁠

. Navigate to ⁠ .bundle_pool ⁠ directory paste the copied ⁠ template ⁠ and ⁠ typelibrary ⁠ folders.
