...
xref:../tutorials/createowntypes.adoc#exportTypes[Export the interface to 4diac FORTE] (`*.h` and `*.cpp` files) and xref:../installation/overview.adoc#externalModules[include them to your build].
