...
The test structure can also be found in https://github.com/eclipse-4diac/4diac-documentation/blob/main/src/development/swtBotTestsStructure.asciidoc[SWTBot Test Structure].
