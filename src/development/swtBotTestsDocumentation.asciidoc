...
image:./img/SWTBot/ClassRunAsSWTBotTest.png[execute all SWTBot tests of a class,width=800]

To execute a single test method *select the method and right click → Run As → SWTBot Test.*

image:./img/SWTBot/RunAsSWTBotTest.png[execute a single test method,width=800]
...
image:./img/SWTBot/RunConfigurationSelection.png[select Run Configuration for class,width=800]
...
image:./img/SWTBot/RunConfigurationMain.png[select Run Configuration for method,width=800]
...
image:./img/SWTBot/BeforeAll.png[@BeforeAll settings,width=450]
...
image:./img/SWTBot/TestResults.png[Test results,width=800]
