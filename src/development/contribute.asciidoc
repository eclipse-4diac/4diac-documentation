...
* **Self Contained:** Commit messages should be self-contained and comprehensible without relying on external links.
...
* Avoid linking to issues, discussions, or pull requests from your commit messages.
====

[TIP]
.Amend or rebase your commits
====
