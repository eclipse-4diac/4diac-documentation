...
url: doc/installation/freertos_lwip.html
...
freeRTOS now also have an extra support for TCP/IP (see https://www.freertos.org/Documentation/03-Libraries/02-FreeRTOS-plus/02-FreeRTOS-plus-TCP/01-FreeRTOS-Plus-TCP[here]) but for now 4diac FORTE is compiled using LwIP.
