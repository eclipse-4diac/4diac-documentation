...
+
image:./img/VSreleaseDebug.png[Release Mode of Visual Studio ]
...
+
image:./img/VSCompile.png[Compile by right-clicking on 4diac FORTE in the Solution Explorer window, and then click Build]

== Debugging

. If you want to Debug using Visual Studio, select the Debug mode and set 4diac FORTEas the main project.
+
image:./img/VSstartProject.png[Set 4diac FORTE as main project in Visual Studio ]
...
xref:../tutorials/overview.html[Step by step tutorial]
