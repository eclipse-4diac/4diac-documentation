...
----
+
image:./img/wagoManager.png[PTXDist Manager]
...
----
+
image:./img/wagoConsole.png[Build Project Console Output]
+
...
image:./img/wago_eclipse_ptxdist1.png[configure Eclipse with ptxdist]

Set [.menu4diac]#Build# within the [.tab4diac]#Behavior# tab to `targetinstall forte_wago` and `Clean`
to `clean forte_wago`.

image:./img/wago_eclipse_ptxdist2.png[add include folders to Eclipse]
...
image:./img/wago_eclipse_ptxdist3.png[FORTE build for Wago in Eclipse]
...
image:./img/wago_eclipse_ptxdist4.png[FORTE build for Wago in Eclipse]

Within the [.view4diac]#Remote System Explorer# perspective, create a [.specicificText]#New Connection# by clicking on image:./img/wago_newConnectionButton.png[New Connection button]. 
...
image:./img/wago_eclipse_ptxdist5.png[FORTE build for Wago in Eclipse]
...
To debug 4diac FORTE on a Wago PFC, click on the small triangle next to image:./img/debug_persp.gif[debug] and choose [.specicificText]#Debug Configurations#. 
...
image:./img/wago_debug_eclipse1.png[FORTE debug for Wago in Eclipse]
...
image:./img/wago_debug_eclipse2.png[FORTE debug for Wago in Eclipse]
...
xref:./index.html[Install Eclipse 4diac]
