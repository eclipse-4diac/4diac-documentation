...
. For the option [.specificText]#FORTE_ARCHITECTURE#, select Win32. 
  Other modules and configurations options can be set following the tutorial step xref:./overview.adoc#generateFilesForCompiling[Build a project with CMake].
