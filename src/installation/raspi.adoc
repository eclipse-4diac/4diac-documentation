...
+
image:./img/raspiCrossLinux2.png[CMake Setup]
. CMake Setup
...
+
image:./img/raspiCrossLinux4.png[Configure 4diac FORTE compilation.]
. Generate files: Click [.button4diac]#Generate#
+
image:./img/raspiCrossLinux5.png[Generate the makefiles.]
