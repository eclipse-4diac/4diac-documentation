...
4diac FORTE is highly configurable, so it is the better choice to build 4diac FORTE from source so you can enable or disable modules and features depending on your requirements.
...
If you want to build 4diac FORTE for an embedded target (Raspberry Pi, freeRTOS, etc.), please have a look at the link:#forteOtherPlatforms[links] on the bottom of this page.
