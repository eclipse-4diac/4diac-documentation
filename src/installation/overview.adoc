...
4diac FORTE is highly configurable, so it is the better choice to build FORTE from source so you can enable or disable modules and features depending on your requirements.
