# Contributing to Eclipse 4diac Documentation
...
The Eclipse 4diac documentation is written using [AsciiDoc](https://docs.asciidoctor.org/asciidoc/latest/).
AsciiDoc is a lightweight markup language. 
The Eclipse 4diac documentation can therefore be edited with any text editor or directly in Github.

In order to preview the output you need:

 - Asciidoctor
 - Maven 

To generate the output run `mvn` in the root directory of this repository. 
The resulting documentation can be found in the target directory.
...
- [GitHub Discussions](https://github.com/eclipse-4diac/4diac-documentation/discussions)
