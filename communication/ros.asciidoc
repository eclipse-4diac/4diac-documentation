...
image:../../html/communication/img/topics_example.PNG[Example
Application using publish and subscribe to send and receive ROS topics]
...
shown next. +
image:../../html/communication/img/fb_trigger_service.PNG[Interface of
the Trigger Service Server and Client SIFB] +
...
image:../../html/communication/img/fb_execute_action.PNG[Interface of
the ExecuteAction Server and Client SIFB] +
